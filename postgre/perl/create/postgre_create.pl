...
sub data_prepare_proc
{
	...
	%dict_aa = text_manipulate::dict_append_proc
		('t3461','広島',78342,'2005-7-12',%dict_aa);
	%dict_aa = text_manipulate::dict_append_proc
		('t3462','福山',14956,'2005-3-15',%dict_aa);
	%dict_aa = text_manipulate::dict_append_proc
		('t3463','東広島',52641,'2005-6-17',%dict_aa);
	%dict_aa = text_manipulate::dict_append_proc
	...
	%dict_aa = text_manipulate::dict_append_proc
		('t3467','三次',35297,'2005-4-10',%dict_aa);
	%dict_aa = text_manipulate::dict_append_proc
		('t3468','大竹',85926,'2005-10-8',%dict_aa);
	%dict_aa = text_manipulate::dict_append_proc
		('t3469','府中',64857,'2005-5-21',%dict_aa);
