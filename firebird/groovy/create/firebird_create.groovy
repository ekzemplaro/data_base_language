...
{
	sql_manipulate.insert_record_proc (sql,"t3821","松山",51567,"1999-8-21")
	sql_manipulate.insert_record_proc (sql,"t3822","今治",24271,"1999-9-14")
	sql_manipulate.insert_record_proc (sql,"t3823","宇和島",38236,"1999-10-27")
	sql_manipulate.insert_record_proc (sql,"t3824","八幡浜",29228,"1999-9-29")
	sql_manipulate.insert_record_proc (sql,"t3825","新居浜",15374,"1999-10-16")
	sql_manipulate.insert_record_proc (sql,"t3826","西条",29747,"1999-11-24")
	sql_manipulate.insert_record_proc (sql,"t3827","大洲",18196,"1999-12-30")
	sql_manipulate.insert_record_proc (sql,"t3828","伊予",43684,"1999-11-18")
