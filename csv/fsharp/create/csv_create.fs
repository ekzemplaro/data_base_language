...
let data_prepare_proc () =
  ...
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1271","千葉",25623,"1997-1-07");
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1272","勝浦",36879,"1997-2-12");
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1273","市原",84926,"1997-3-28");
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1274","流山",29513,"1997-2-21");

  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1275","八千代",81978,"1997-1-5");
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1276","我孫子",75647,"1997-5-22");
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1277","鴨川",46786,"1997-7-17");
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t1278","銚子",54535,"1997-3-4");
