...
let data_prepare_proc = fun () ->
	...
	in let _ = dict_append_proc dict_aa "t1273" "市原" 12756 "1995-5-21"
	in let _ = dict_append_proc dict_aa "t1274" "流山" 83239 "1995-3-24"
	in let _ = dict_append_proc dict_aa "t1275" "八千代" 64125 "1995-8-18"
	in let _ = dict_append_proc dict_aa "t1276" "我孫子" 72698 "1995-9-8"
	in let _ = dict_append_proc dict_aa "t1277" "鴨川" 81375 "1995-2-17"
