...
static data_prepare_proc ()
{
	...
	dict_aa = ff.dict_append_proc (dict_aa,"t1274","流山",54296,"1999-5-2")
	dict_aa = ff.dict_append_proc (dict_aa,"t1275","八千代",28175,"1999-9-9")
	dict_aa = ff.dict_append_proc (dict_aa,"t1276","我孫子",12736,"1999-6-30")
	dict_aa = ff.dict_append_proc (dict_aa,"t1277","鴨川",27538,"1999-4-22")
