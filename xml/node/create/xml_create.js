...
function data_prepare_proc ()
{
	...
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2263','沼津',59741,'1950-7-2');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2264','三島',38724,'1950-2-22');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2265','富士',48312,'1950-8-14');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2266','熱海',69274,'1950-9-12');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2267','富士宮',78251,'1950-3-21');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2268','藤枝',57436,'1950-7-26');
