...
static data_prepare_proc ()
{
	...
	dict_aa = ff.dict_append_proc (dict_aa,"t2262","浜松",28674,"1999-12-16")
	dict_aa = ff.dict_append_proc (dict_aa,"t2263","沼津",79562,"1999-8-9")
	dict_aa = ff.dict_append_proc (dict_aa,"t2264","三島",54716,"1999-5-2")
	dict_aa = ff.dict_append_proc (dict_aa,"t2265","富士",23165,"1999-9-9")
	dict_aa = ff.dict_append_proc (dict_aa,"t2266","熱海",18293,"1999-6-30")
	...
	dict_aa = ff.dict_append_proc (dict_aa,"t2270","島田",21598,"1999-5-14")
