...
open(20,file=filename,status='replace')
	...
	call out_proc ('t2262','浜松',52697,'1940-10-21')
	call out_proc ('t2263','沼津',34593,'1940-5-16')
	call out_proc ('t2264','三島',52492,'1940-9-3')
	call out_proc ('t2265','富士',41831,'1940-3-9')
	call out_proc ('t2266','熱海',82573,'1940-5-19')
	call out_proc ('t2267','富士宮',51748,'1940-9-24')
	call out_proc ('t2268','藤枝',94172,'1940-8-18')
	call out_proc ('t2269','御殿場',57564,'1940-7-11')
