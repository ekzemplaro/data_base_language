...
var out_str:string = xml_manipulate.dict_to_xml_proc (dict_aa);
...
function data_prepare_proc ()
{
	...
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2262','浜松',28197,'1950-10-25');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2263','沼津',79341,'1950-7-2');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2264','三島',31924,'1950-2-22');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2265','富士',48712,'1950-8-14');
	...
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2268','藤枝',52436,'1950-7-26');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2269','御殿場',74827,'1950-11-8');
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t2270','島田',91845,'1950-12-21');
