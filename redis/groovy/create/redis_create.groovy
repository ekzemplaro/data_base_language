...
static void main(String[] args)  throws Exception
{
	...
	create_record_proc (jedis,"t1852","敦賀",42687,"1999-2-8")
	create_record_proc (jedis,"t1853","小浜",34782,"1999-8-21")
	create_record_proc (jedis,"t1854","大野",79435,"1999-3-17")
	create_record_proc (jedis,"t1855","勝山",25374,"1999-5-14")
	create_record_proc (jedis,"t1856","鯖江",86537,"1999-10-28")
	create_record_proc (jedis,"t1857","あわら",62731,"1999-7-11")
	create_record_proc (jedis,"t1858","越前",89653,"1999-8-30")
	create_record_proc (jedis,"t1859","坂井",94632,"1999-11-20")
