...
def insert_data_proc (sss:Statement)
{
	...
	sql_manipulate.insert_record_proc (sss,"t0713","白河", 20259,"1998-5-27")
	sql_manipulate.insert_record_proc (sss,"t0714","福島",57286,"1998-9-29")
	sql_manipulate.insert_record_proc (sss,"t0715","喜多方",12937,"1998-2-16")
	sql_manipulate.insert_record_proc (sss,"t0716","二本松",19784,"1998-11-24")
	sql_manipulate.insert_record_proc (sss,"t0717","いわき",18219,"1998-12-30")
	sql_manipulate.insert_record_proc (sss,"t0718","相馬",45184,"1998-10-12")
	sql_manipulate.insert_record_proc (sss,"t0719","須賀川",52378,"1998-7-15")
}
