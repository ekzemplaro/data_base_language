...
static int main (string[] args)
{
	...
	insert_proc (db,"t0711","郡山","84962","1987-4-12");
	insert_proc (db,"t0712","会津若松","42815","1987-7-24");
	insert_proc (db,"t0713","白河","51594","1987-9-8");
	insert_proc (db,"t0714","福島","71687","1987-2-9");
	insert_proc (db,"t0715","喜多方","37569","1987-5-1");
	insert_proc (db,"t0716","二本松","42452","1987-6-4");
	insert_proc (db,"t0717","いわき","81748","1987-3-21");
	insert_proc (db,"t0718","相馬","21851","1987-1-12");
	insert_proc (db,"t0719","須賀川","14527","1987-10-18");
