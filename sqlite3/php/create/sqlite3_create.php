...
insert_proc ($dbcon,'t0712','会津若松',78612,'2002-6-14');
insert_proc ($dbcon,'t0713','白河', 83246,'2002-5-27');
insert_proc ($dbcon,'t0714','福島', 51897,'2002-7-18');
insert_proc ($dbcon,'t0715','喜多方', 79621,'2002-8-24');
insert_proc ($dbcon,'t0716','二本松', 31548,'2002-9-23');
insert_proc ($dbcon,'t0717','いわき', 24763,'2002-5-17');
insert_proc ($dbcon,'t0718','相馬', 74815,'2002-5-4');
insert_proc ($dbcon,'t0719','須賀川', 57349,'2002-10-24');
