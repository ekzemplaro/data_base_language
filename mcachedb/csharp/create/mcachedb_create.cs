...
static void mcached_write_proc (MemcachedClient mc)
{
	...
	mcache_manipulate.data_put_proc (mc,"t1523","新発田",52373,"2009-7-11");
	mcache_manipulate.data_put_proc (mc,"t1524","上越",29892,"2009-3-17");
	mcache_manipulate.data_put_proc (mc,"t1525","糸魚川",71561,"2009-10-5");
	mcache_manipulate.data_put_proc (mc,"t1526","加茂",32745,"2009-9-14");
	mcache_manipulate.data_put_proc (mc,"t1527","三条",25968,"2009-7-17");
	mcache_manipulate.data_put_proc (mc,"t1528","佐渡",74527,"2009-1-26");
	mcache_manipulate.data_put_proc (mc,"t1529","柏崎",37816,"2009-7-19");
	mcache_manipulate.data_put_proc (mc,"t1530","村上",47214,"2009-9-2");
