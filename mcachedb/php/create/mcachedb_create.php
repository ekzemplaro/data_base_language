...
$dict_aa = dict_append_proc ($dict_aa,'t1521','新潟',78614,'2002-4-14');
$dict_aa = dict_append_proc ($dict_aa,'t1522','長岡',92573,'2002-7-12');
...
$dict_aa = dict_append_proc ($dict_aa,'t1530','村上',25371,'2002-5-12');
$dict_aa = dict_append_proc ($dict_aa,'t1531','十日町',38579,'2002-9-25');
$dict_aa = dict_append_proc ($dict_aa,'t1532','五泉',67428,'2002-10-7');
