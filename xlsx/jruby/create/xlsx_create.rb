...
def prepare_data_proc ()
	dict_aa = {}
	dict_aa=dict_append_proc(dict_aa,"t2971","奈良",78564,"2007-8-26")
	dict_aa=dict_append_proc(dict_aa,"t2972","大和高田",26478,"2007-4-27")
	dict_aa=dict_append_proc(dict_aa,"t2973","大和郡山",58126,"2007-2-8")
	dict_aa=dict_append_proc(dict_aa,"t2974","天理",37915,"2007-1-21")
