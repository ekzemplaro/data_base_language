...
// --------------------------------------------------------------------
// [6-4]:
function initializePlot(axisKeys,initialDuration,axisRange,scales,scene)
{
	initializeAxis(axisKeys,0,initialDuration,axisRange,scales,scene)
	initializeAxis(axisKeys,1,initialDuration,axisRange,scales,scene)
	initializeAxis(axisKeys,2,initialDuration,axisRange,scales,scene)
}


// --------------------------------------------------------------------
function initializeAxis(axisKeys, axisIndex,initialDuration,axisRange,scales,scene )
{
    var key = axisKeys[axisIndex];
    drawAxis( axisIndex, key, initialDuration,axisRange, scales,scene );
...
// --------------------------------------------------------------------
function drawAxis( axisIndex, key, duration, axisRange, scales,scene )
{
...
// --------------------------------------------------------------------
// [6-6]:
function plotData( duration,rows,scales,scene,ease,axisKeys )
{
...
function updateData() {
    ...
    if ( x3d.node() && x3d.node().runtime ) {
      ...
      plotData( defaultDuration,rows,scales,scene,ease,axisKeys );
    } else {
...
// --------------------------------------------------------------------
	initializeDataGrid()
	initializePlot(axisKeys,initialDuration,axisRange,scales,scene)
