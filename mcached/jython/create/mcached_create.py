...
def	data_prepare_proc ():
	dict_aa = {} 
#
	dict_aa = dict_append_proc (dict_aa,'t1731','金沢',17592,'2004-11-4')
	...
	dict_aa = dict_append_proc (dict_aa,'t1738','かほく',23184,'2004-4-26')
	dict_aa = dict_append_proc (dict_aa,'t1739','白山',75923,'2004-12-15')
#
	return	dict_aa
# ----------------------------------------------------------------
print ("*** 開始 ***")
