	...
	data_prepare_proc ()
{
	...
	dict_aa = dict_append_proc (dict_aa,"t2384","一宮",81452,"1923-3-12");
	dict_aa = dict_append_proc (dict_aa,"t2385","蒲郡",58169,"1923-7-18");
	dict_aa = dict_append_proc (dict_aa,"t2386","常滑",91427,"1923-8-13");
	dict_aa = dict_append_proc (dict_aa,"t2387","大府",18736,"1923-1-5");
	dict_aa = dict_append_proc (dict_aa,"t2388","瀬戸",34792,"1923-2-22");
