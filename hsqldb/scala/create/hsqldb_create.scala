...
def insert_data_proc (sss:Statement)
{
	...
	sql_manipulate.insert_record_proc (sss,"t4672","指宿",41348,"1998-5-21")
	sql_manipulate.insert_record_proc (sss,"t4673","志布志",64259,"1998-5-21")
	sql_manipulate.insert_record_proc (sss,"t4674","川内",27234,"1998-9-28")
	sql_manipulate.insert_record_proc (sss,"t4675","鹿屋",12917,"1998-10-6")
	sql_manipulate.insert_record_proc (sss,"t4676","枕崎",34513,"1998-11-21")
	sql_manipulate.insert_record_proc (sss,"t4677","出水",19831,"1998-2-6")
	sql_manipulate.insert_record_proc (sss,"t4678","阿久根",49432,"1998-5-29")
