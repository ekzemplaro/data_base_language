...
function data_prepare_proc ()
{
	...
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t3251','松江',38714,'1950-3-12')
	...
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t3254','雲南',86134,'1950-9-22')
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t3255','江津',45618,'1950-2-14')
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t3256','浜田',65492,'1950-1-12')
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t3257','益田',38251,'1950-3-21')
	dict_aa = text_manipulate.dict_append_proc (dict_aa,'t3258','安来',52786,'1950-7-26')
