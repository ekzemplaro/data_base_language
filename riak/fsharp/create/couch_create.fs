...
let data_prepare_proc () =
  ...
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t2021","長野",25623,"1997-1-7")
  ...
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t2025","岡谷",81978,"1997-1-5")
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t2026","塩尻",75647,"1997-5-22")
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t2027","茅野",46786,"1997-7-17")
  let dict_aa = text_manipulate.dict_append_proc (dict_aa,"t2028","飯田",54535,"1997-3-4")
