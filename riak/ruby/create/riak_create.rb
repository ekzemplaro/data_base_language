...
dict_aa=dict_append_proc(dict_aa,'t3251',"松江",57843,"2006-8-25")
dict_aa=dict_append_proc(dict_aa,'t3252',"出雲",21789,"2006-6-24")
dict_aa=dict_append_proc(dict_aa,'t3253',"大田",48251,"2006-10-8")
dict_aa=dict_append_proc(dict_aa,'t3254',"雲南",75623,"2006-1-22")
