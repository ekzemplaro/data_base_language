...
def data_prepare_proc ()
	dict_aa = {}
	dict_aa=dict_append_proc(dict_aa,"t2761","豊中",65841,"2006-3-15")
	dict_aa=dict_append_proc(dict_aa,"t2762","池田",85937,"2006-8-28")
	dict_aa=dict_append_proc(dict_aa,"t2763","高槻",56829,"2006-2-9")
	...
	dict_aa=dict_append_proc(dict_aa,"t2769","高石",74325,"2006-10-27")
#
	return	dict_aa
end
# ------------------------------------------------------------
