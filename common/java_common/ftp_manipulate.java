...
// --------------------------------------------------------------
public static String ftp_get_proc
	(String hostname,String user,String passwd,String path_file)
{
...
// --------------------------------------------------------------
public static void ftp_put_proc
	(String hostname,String user,String passwd,String file_path,
	String str_data)
		throws Exception
{
