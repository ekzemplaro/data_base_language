...
echo '{"name":"加賀","population":41500,"date_mod":"2001-10-17"}' > t1736
echo '{"name":"羽咋","population":38300,"date_mod":"2001-11-23"}' > t1737
echo '{"name":"かほく","population":58400,"date_mod":"2001-12-19"}' > t1738
echo '{"name":"白山","population":48100,"date_mod":"2001-11-17"}' > t1739
#
memcflush --servers=localhost:11211
memccp --servers=localhost:11211 --set t1731 t1732 t1733 t1734 t1735 t1736 t1737 t1738 t1739
#
rm /tmp/t173*
#
echo "*** OK ***"
