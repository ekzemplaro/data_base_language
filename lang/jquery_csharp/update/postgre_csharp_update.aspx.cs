...
// ----------------------------------------------------------------
public class postgre_csharp_update : System.Web.UI.Page {
...
void Page_Load (Object sender, EventArgs e)
{
	...
	Response.Write ("postgre_csharp_update.aspx.cs ");
	...
	for (int it=0; it< dtx.Rows.Count; it++)
		...
		table_manipulate.update_proc (ref dtable,id_aa,population_aa);
		}

	postgre_manipulate.data_update_proc (str_connect,dtable);

	Response.Write ("Apr/21/2010 ");
