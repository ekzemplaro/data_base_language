...
def	data_prepare_proc ():
	dict_aa = {} 
#
	dict_aa = dict_append_proc (dict_aa,'t2451','津',51600,'2003-10-30')
	dict_aa = dict_append_proc (dict_aa,'t2452','鈴鹿',21500,'2003-5-10')
	dict_aa = dict_append_proc (dict_aa,'t2453','伊勢',25400,'2003-6-14')
	dict_aa = dict_append_proc (dict_aa,'t2454','鳥羽',83900,'2003-9-9')
	dict_aa = dict_append_proc (dict_aa,'t2455','四日市',48100,'2003-8-4')
