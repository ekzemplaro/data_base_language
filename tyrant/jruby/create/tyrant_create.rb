...
def prepare_data_proc ()
	dict_aa = {}
	dict_aa=dict_append_proc(dict_aa,"t4761","那覇",61534,"2007-8-6")
	...
	dict_aa=dict_append_proc(dict_aa,"t4768","豊見城",34192,"2007-7-25")
	dict_aa=dict_append_proc(dict_aa,"t4769","うるま",74926,"2007-5-17")
#
	return	dict_aa
end
# ------------------------------------------------------------
