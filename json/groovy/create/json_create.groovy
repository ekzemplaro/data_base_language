...
static data_prepare_proc ()
{
	...
	dict_aa = ff.dict_append_proc (dict_aa,"t0922","小山",28674,"1999-2-26")
	...
	dict_aa = ff.dict_append_proc (dict_aa,"t0927","さくら",26571,"1999-4-22")
	dict_aa = ff.dict_append_proc (dict_aa,"t0928","矢板",16593,"1999-3-17")
	...
	dict_aa = ff.dict_append_proc (dict_aa,"t0933","那須塩原",72642,"1999-8-18")
	dict_aa = ff.dict_append_proc (dict_aa,"t0934","那須烏山",92137,"1999-9-274")
