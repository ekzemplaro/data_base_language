...
open(20,file=filename,status='replace')
	...
	call out_proc ('t0922','小山',52627,'1940-10-21',',')
	call out_proc ('t0923','佐野',34583,'1940-5-16',',')
	call out_proc ('t0924','足利',52492,'1940-9-23',',')
	call out_proc ('t0925','日光',41861,'1940-3-9',',')
	call out_proc ('t0926','下野',82573,'1940-5-19',',')
	call out_proc ('t0927','さくら',51748,'1940-9-12',',')
	call out_proc ('t0928','矢板',94312,'1940-8-18',',')
	call out_proc ('t0929','真岡',57564,'1940-7-11',',')
	call out_proc ('t0930','栃木',56392,'1940-9-24',',')
	call out_proc ('t0931','大田原',16425,'1940-8-26',',')
	call out_proc ('t0932','鹿沼',42531,'1940-7-14',',')
	call out_proc ('t0933','鹿沼',78254,'1940-3-12',',')
	call out_proc ('t0934','那須烏山',25812,'1940-5-8','}')
