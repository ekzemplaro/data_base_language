...
def	data_prepare_proc ():
	dict_aa = {}
	dict_aa = dict_append_proc (dict_aa,'t0921',u'宇都宮',41595,'2003-8-12')
#
	dict_aa = dict_append_proc (dict_aa,'t0922',u'小山',38756,'2003-5-15')
#
	dict_aa = dict_append_proc (dict_aa,'t0923',u'佐野',51294,'2003-6-12')
	dict_aa = dict_append_proc (dict_aa,'t0924',u'足利',57538,'2003-7-21')
	dict_aa = dict_append_proc (dict_aa,'t0925',u'日光',72682,'2003-4-19')
	...
	dict_aa = dict_append_proc (dict_aa,'t0930',u'栃木',82854,'2003-7-04')
