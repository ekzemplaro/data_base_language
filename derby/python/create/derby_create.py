...
def	data_prepare_proc ():
	dict_aa = {} 
#
	dict_aa = dict_append_proc (dict_aa,'t3551','山口',29176,'2003-4-30')
	dict_aa = dict_append_proc (dict_aa,'t3552','下関',47935,'2003-5-10')
	dict_aa = dict_append_proc (dict_aa,'t3553','萩',71654,'2003-6-14')
	dict_aa = dict_append_proc (dict_aa,'t3554','徳山',83672,'2003-9-9')
	dict_aa = dict_append_proc (dict_aa,'t3555','岩国',42591,'2003-8-4')
